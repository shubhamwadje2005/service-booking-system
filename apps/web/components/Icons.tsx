...
export function Clock({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronUp({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronLeft({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Briefcase({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Edit2({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Sparkles({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 3l1.912 4.678a2 2 0 0 0 1.41 1.41L20 11l-4.678 1.912a2 2 0 0 0-1.41 1.41L12 19l-1.912-4.678a2 2 0 0 0-1.41-1.41L4 11l4.678-1.912a2 2 0 0 0 1.41-1.41L12 3z" />
    </svg>
  );
}

export function Star({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Phone({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ImageIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
